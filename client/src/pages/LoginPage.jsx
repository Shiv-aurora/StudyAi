        ...
        <div className="flex h-screen w-full bg-gray-50">
            ...
            <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-teal-400 to-emerald-600 justify-center items-center text-white relative overflow-hidden">
                ...
                <div className="z-10 text-center px-10">
                    ...
                    <p className="text-xl font-light">
                        To keep connected with your study goals, please login with your personal info.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full md:w-1/2 flex justify-center items-center bg-white p-8">
                <div className="max-w-md w-full">
                    ...
                    <p className="text-center text-gray-400 text-sm mb-6">or use your email account</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <Link to="/forgot-password" class="text-xs text-gray-500 hover:text-teal-600 block text-center pt-2">Forgot your password?</Link>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-gray-500 mb-4">New here? <Link to="/signup" className="text-teal-500 font-bold hover:underline">Create Account</Link></p>
