...
const guestLogin = async (req, res) => {
    ...
    try {
        ...
        // 3. Seed Data (Sequential - slower but safer for ensuring IDs match)
        try {
            // Sequential Create Courses to get IDs properly
            ...
            // Sequential Create Tasks (Using direct IDs from above)
            await Task.create([
